...
<body>
    ...
    <section class="hero-section"
        style="
        background-image: url('{{ asset('storage/' . $budaya->gambar) }}');
    ">
        <div class="hero-overlay"></div>

        <div class="hero-content">
            <h1 class="hero-title">{{ $budaya->nama }}</h1>

            @if ($budaya->konteks)
                <p class="hero-desc">{{ $budaya->konteks }}</p>
            @endif
        </div>
    </section>
    ...
    <section class="content-section">
        {{-- <div class="desc-head">
    <h1>{{ $budaya->kategori }} {{ $budaya->nama }}</h1>

    <div class="right-underline"></div>

    @if ($budaya->deskripsi_singkat)
    ...
    @endif
        ...
        <div class="content-wrapper">
            ...
            <div class="content-left">
                <h2 class="content-title">{{ $budaya->kategori }} {{ $budaya->nama }}</h2>
        ...
        <div class="layout-wrapper">
            ...
            <!-- LEFT 25% -->
            <div class="left-info">
                <h1>Explor Budaya Lain Juga</h1>
                <p>Jelajahi Beragam Budaya Di Maluku</p>
            </div>
            <!-- RIGHT 75% -->
            <div class="right-gallery">
                <div class="gallery">

                    @foreach ($budayaLain as $item)
